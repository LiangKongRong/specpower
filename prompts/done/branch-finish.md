...
**Announce at start:** "I'm using specpower:done to complete this work."
...
**Called by:**
- **specpower:build Phase B** (final step) - After all tasks complete
- **specpower:build Phase B (inline mode)** (final step) - After all batches complete

**Pairs with:**
- **specpower:build Phase B (worktree)** - Cleans up worktree created by that skill
