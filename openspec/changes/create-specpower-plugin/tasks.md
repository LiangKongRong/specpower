...
- [ ] 1.1 Initialize npm package with TypeScript
...
- [ ] 1.3 Create CLI entry point skeleton
...
- [ ] 1.4 Add code-review-graph as dependency
...
- [ ] 2.1 TEST: Write tests for file-system utilities
...
- [ ] 2.2 IMPLEMENT: Port file-system utilities
...
- [ ] 2.3 TEST: Write tests for change-metadata and change-utils
...
- [ ] 2.4 IMPLEMENT: Port change-metadata and change-utils
...
- [ ] 2.5 TEST: Write tests for task-progress utilities
...
- [ ] 2.6 IMPLEMENT: Port task-progress utilities
...
- [ ] 2.7 Create utils barrel export
...
- [ ] 3.1 TEST: Write tests for Markdown delta-spec parser
...
- [ ] 3.2 IMPLEMENT: Port Markdown delta-spec parser
...
- [ ] 3.3 TEST: Write tests for requirement-blocks parser
...
- [ ] 3.4 IMPLEMENT: Port requirement-blocks parser
...
- [ ] 3.5 TEST: Write tests for change-parser and spec-structure
...
- [ ] 3.6 IMPLEMENT: Port change-parser and spec-structure
...
- [ ] 3.7 Create parsers barrel export
...
- [ ] 4.1 TEST: Write tests for artifact graph types and schema loader
...
- [ ] 4.2 IMPLEMENT: Port artifact graph types, schema loader, resolver
...
- [ ] 4.3 TEST: Write tests for dependency graph operations
...
- [ ] 4.4 IMPLEMENT: Port ArtifactGraph class
...
- [ ] 4.5 TEST: Write tests for artifact state tracker and instruction loader
...
- [ ] 4.6 IMPLEMENT: Port artifact state tracker and instruction loader
...
- [ ] 4.7 Create artifact-graph barrel export
...
- [ ] 5.1 TEST: Write tests for spec validation
...
- [ ] 6.1 Create test fixture files for delta merge
...
- [ ] 6.2 TEST: Write tests for delta spec merge
...
- [ ] 6.3 IMPLEMENT: Port specs-apply
...
- [ ] 6.4 TEST: Write tests for archive workflow
...
- [ ] 7.1 TEST: Write tests for template system
...
- [ ] 7.2 IMPLEMENT: Port template system
...
- [ ] 7.3 Create specpower schema.yaml
...
- [ ] 8.1 TEST: Write tests for `specpower change new`
...
- [ ] 8.2 IMPLEMENT: specpower change new
...
- [ ] 8.3 TEST: Write tests for `specpower change status`
...
- [ ] 8.4 IMPLEMENT: specpower change status
...
- [ ] 8.5 TEST: Write tests for `specpower change archive`
...
- [ ] 8.6 IMPLEMENT: specpower change archive
...
- [ ] 8.7 TEST: Write tests for `specpower instructions`
...
- [ ] 8.8 IMPLEMENT: specpower instructions
...
- [ ] 8.9 TEST: Write tests for `specpower validate`
...
- [ ] 8.10 IMPLEMENT: specpower validate
...
- [ ] 9.1 TEST: Write tests for `specpower scan`
...
- [ ] 10.1 Extract proposal instruction
...
- [ ] 10.2 Extract specs instruction
...
- [ ] 10.3 Extract design instruction
...
- [ ] 10.4 Extract tasks instruction
...
- [ ] 10.5 Extract apply instruction
...
- [ ] 11.1 Rewrite brainstorming → `prompts/refine/brainstorm.md`
...
- [ ] 11.2 Rewrite brainstorming reviewer → `prompts/refine/spec-document-reviewer.md`
  - Source: `obra/superpowers skills/brainstorming/spec-document-reviewer-prompt.md`
  - Verify: file exists, `grep -ci superpowers` = 0

- [ ] 11.3 Rewrite writing-plans → `prompts/build/phase-a-plan.md`
...
- [ ] 11.4 Rewrite plan reviewer → `prompts/build/plan-document-reviewer.md`
  - Source: `obra/superpowers skills/writing-plans/plan-document-reviewer-prompt.md`
  - Verify: file exists, no stale references

- [ ] 11.5 Rewrite subagent-driven-development → `prompts/build/phase-b-execute.md`
...
- [ ] 11.6 Rewrite using-git-worktrees → `prompts/build/phase-b-worktree.md`
...
- [ ] 11.7 Rewrite test-driven-development → `prompts/build/tdd.md` (build variant)
...
- [ ] 11.8 Rewrite test-driven-development → `prompts/test/tdd.md` (standalone test variant)
  - Source: same as 11.7
...
- [ ] 11.9 Rewrite requesting-code-review + code-reviewer → `prompts/review/code-review.md`
...
- [ ] 11.10 Rewrite systematic-debugging → `prompts/fix/debug.md`
...
- [ ] 11.11 Rewrite verification-before-completion → `prompts/test/verification.md` (test variant)
...
- [ ] 11.12 Rewrite verification-before-completion → `prompts/verify/verification.md` (verify variant)
...
- [ ] 11.13 Rewrite finishing-a-development-branch → `prompts/done/branch-finish.md`
...
- [ ] 12.1 Create `prompts/plan/proposal.md`
...
- [ ] 12.2 Create `prompts/plan/specs.md`
...
- [ ] 12.3 Create `prompts/refine/design-output.md`
...
- [ ] 12.4 Create `prompts/build/phase-b-review.md`
...
- [ ] 13.1 Rewrite implementer-prompt → `prompts/shared/implementer-prompt.md`
...
- [ ] 13.2 Rewrite spec-reviewer-prompt → `prompts/shared/spec-reviewer-prompt.md`
...
- [ ] 13.3 Rewrite code-quality-reviewer-prompt → `prompts/shared/code-reviewer-prompt.md`
...
- [ ] 13.4 Rewrite dispatching-parallel-agents → `prompts/shared/dispatching-parallel-agents.md`
  - Source: `obra/superpowers skills/dispatching-parallel-agents/SKILL.md`
  - Verify: when-to-use / not-for criteria preserved

- [ ] 13.5 Rewrite executing-plans → `prompts/shared/executing-plans.md`
...
- [ ] 13.6 Rewrite receiving-code-review → `prompts/shared/receiving-code-review.md`
...
- [ ] 14.1 Copy using-superpowers → `prompts/reference/superpowers/using-superpowers.md`
  - Source: `obra/superpowers skills/using-superpowers/SKILL.md`
  - Copy as-is (reference only)

- [ ] 14.2 Copy writing-skills → `prompts/reference/superpowers/writing-skills.md`
  - Source: `obra/superpowers skills/writing-skills/SKILL.md` (~22KB)
  - Copy as-is

- [ ] 14.3 Copy anthropic-best-practices.md (~45KB)
...
- [ ] 14.4 Copy testing-anti-patterns.md
...
- [ ] 14.5 Copy systematic-debugging reference files (5 files)
...
- [ ] 14.6 Copy writing-skills reference files (3 files)
...
- [ ] 15.1 Create `skills/specpower-scan/SKILL.md`
...
- [ ] 15.2 Create `skills/specpower-plan/SKILL.md`
...
- [ ] 15.3 Create `skills/specpower-refine/SKILL.md`
...
- [ ] 15.4 Create `skills/specpower-build/SKILL.md`
...
- [ ] 15.5 Create `skills/specpower-review/SKILL.md`
...
- [ ] 15.6 Create `skills/specpower-test/SKILL.md`
...
- [ ] 15.7 Create `skills/specpower-verify/SKILL.md`
...
- [ ] 15.8 Create `skills/specpower-done/SKILL.md`
...
- [ ] 15.9 Create `skills/specpower-fix/SKILL.md`
...
- [ ] 15.10 Create `skills/specpower-snap/SKILL.md`
...
- [ ] 16.1 TEST: Write tests for specpower init
...
- [ ] 17.1 Integration test: full change lifecycle
...
- [ ] 17.2 Integration test: delta merge round-trip
...
- [ ] 17.3 Integration test: progressive loading paths
...
- [ ] 17.4 Verify npm package build and install
  - Steps:
